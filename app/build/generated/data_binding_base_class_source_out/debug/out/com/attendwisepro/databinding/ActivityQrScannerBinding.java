...
public final class ActivityQrScannerBinding implements ViewBinding {
  ...
  private ActivityQrScannerBinding(@NonNull ConstraintLayout rootView,
      @NonNull PreviewView previewView, @NonNull View qrOverlay) {
  ...
  public static ActivityQrScannerBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.qrOverlay;
      View qrOverlay = ViewBindings.findChildViewById(rootView, id);
      if (qrOverlay == null) {
        break missingId;
      }

      return new ActivityQrScannerBinding((ConstraintLayout) rootView, previewView, qrOverlay);
    }
