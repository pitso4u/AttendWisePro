...
public final class ActivityEmployeesBinding implements ViewBinding {
  ...
  private ActivityEmployeesBinding(@NonNull CoordinatorLayout rootView, @NonNull TextView emptyView,
  ...
  public static ActivityEmployeesBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityEmployeesBinding((CoordinatorLayout) rootView, emptyView, fabAdd,
