...
public final class ItemEmployeeBinding implements ViewBinding {
  ...
  private ItemEmployeeBinding(@NonNull MaterialCardView rootView,
      @NonNull TextView departmentTextView, @NonNull TextView emailTextView,
      @NonNull TextView idTextView, @NonNull TextView nameTextView,
      @NonNull TextView positionTextView) {
  ...
  public static ItemEmployeeBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ItemEmployeeBinding((MaterialCardView) rootView, departmentTextView, emailTextView,
          idTextView, nameTextView, positionTextView);
    }
